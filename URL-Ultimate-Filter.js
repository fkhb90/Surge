/**
 * @file        URL-Ultimate-Filter-Surge-V28-Optimized.js
 * @version     28.0
 * @description 基於V27版本，修正兩處關鍵的攔截邏輯錯誤，提升對帶有查詢參數的URL的過濾精準度。
 * @author      Claude & Gemini & walkingway
...
🚨 關鍵追蹤腳本攔截清單 (V27 擴充) */ const CRITICAL_TRACKING_SCRIPTS = new Set([ // Core Lists (V25) 'ytag.js', 'gtag.js', 'gtm.js', 'ga.js', 'analytics.js', 'adsbygoogle.js', 'ads.js', 'fbevents.js', 'fbq.js', 'pixel.js', 'connect.js', 'tracking.js', 'tracker.js', 'tag.js', 'doubleclick.js', 'adsense.js', 'adloader.js', 'hotjar.js', 'mixpanel.js', 'amplitude.js', 'segment.js', 'clarity.js', 'matomo.js', 'piwik.js', 'fullstory.js', 'heap.js', 'inspectlet.js', 'logrocket.js', 'vwo.js', 'optimizely.js', 'criteo.js', 'pubmatic.js', 'outbrain.js', 'taboola.js', 'prebid.js', 'apstag.js', 'utag.js', 'beacon.js', 'event.js', 'collect.js', 'activity.js', 'conversion.js', 'action.js', 'abtasty.js', 'cmp.js', 'sp.js', 'adobedtm.js', 'visitorapi.js', 'intercom.js', 'link-click-tracker.js', 'user-timing.js', 'cf.js', 'tagtoo.js', // V25 China Expansion (Retained) 'hm.js', 'u.js', 'um.js', 'aplus.js', 'aplus_wap.js', 'gdt.js', // V27 New Additions 'tiktok-pixel.js', 'tiktok-analytics.js', 'pangle.js', 'ec.js', 'autotrack.js', 'capture.js', 'user-id.js', 'adroll.js', 'adroll_pro.js', 'quant.js', 'quantcast.js', 'comscore.js', 'dax.js', 'chartbeat.js', 'crazyegg.js', 'mouseflow.js', 'newrelic.js', 'nr-loader.js', 'perf.js', 'trace.js', 'tracking-api.js', 'scevent.min.js', 'ad-sdk.js', 'ad-manager.js', 'ad-player.js', 'ad-lib.js', 'ad-core.js' ]);
/**

🚨 關鍵追蹤路徑模式 (V27 擴充) */ const CRITICAL_TRACKING_PATTERNS = new Set([ // Core Lists (V25) '/googletagmanager/', '/google-analytics/', '/googlesyndication/', '/doubleclick/', '/googleadservices/', 'google.com/ads', 'google.com/pagead', '/pagead/gen_204', 'facebook.com/tr', 'facebook.com/tr/', '/collect?', '/track/', '/v1/event', '/v1/events', '/events/', '/beacon/', '/pixel/', '/telemetry/', '/api/log/', '/api/track/', '/api/collect/', '/api/v1/track', 'scorecardresearch.com/beacon.js', 'analytics.twitter.com', 'ads.linkedin.com/li/track', 'amazon-adsystem.com/e/ec', 'ads.yahoo.com/pixel', 'ads.bing.com/msclkid', 'segment.io/v1/track', 'heap.io/api/track', 'api.mixpanel.com/track', 'api.amplitude.com', '/v2/event', '/v2/events', '/intake', '/batch', '/abtesting/', '/feature-flag/', '/user-profile/', 'api-iam.intercom.io/messenger/web/events', 'api.hubspot.com/events', '/b/ss', '/i/adsct', 'cacafly/track', '/track/m', '/track/pc', // V25 China Expansion (Retained) 'hm.baidu.com/hm.js', 'cnzz.com/stat.php', 'wgo.mmstat.com', '/log/aplus', '/v.gif', 'gdt.qq.com/gdt_mview.fcg', // V27 New Additions '/v1/pixel', 'ads.tiktok.com/i18n/pixel/events.js', 'ads-api.tiktok.com/api/v2/pixel', 'analytics.snapchat.com/v1/batch', 'tr.snapchat.com', 'sc-static.net/scevent.min.js', '/api/v2/event', '/i/adsct', '/stats.g.doubleclick.net/j/collect', '/ad/v1/event', 'px.ads.linkedin.com', 'ads.pinterest.com/v3/conversions/events', '/ads/ga-audiences', 'ad.360yield.com', '/ad-call', '/adx/', '/adsales/', '/adserver/', '/adsync/', '/adtech/' ]);
/**

✅ 路徑白名單 (無變更) */ const PATH_ALLOW_PATTERNS = new Set(['chunk.js', 'chunk.mjs', 'polyfill.js', 'fetch-polyfill', 'browser.js', 'sw.js', 'loader.js', 'header.js', 'head.js', 'padding.css', 'badge.svg', 'modal.js', 'card.js', 'download', 'upload', 'payload', 'broadcast', 'roadmap', 'gradient', 'shadow', 'board', 'dialog', 'blog', 'catalog', 'game', 'language', 'page', 'page-data.js', 'legacy.js', 'article', 'assets', 'cart', 'chart', 'start', 'parts', 'partner', 'amp-anim', 'amp-animation', 'amp-iframe', 'api', 'service', 'endpoint', 'webhook', 'callback', 'oauth', 'auth', 'login', 'register', 'profile', 'dashboard', 'admin', 'config', 'settings', 'preference', 'notification', 'message', 'chat', 'comment', 'review', 'rating', 'search', 'filter', 'sort', 'category', 'media', 'image', 'video', 'audio', 'document', 'pdf', 'export', 'import', 'backup', 'restore', 'sync', 'feed', 'rss', 'atom', 'xml', 'opml', 'subscription', 'subscribe', 'collections', 'boards', 'streams', 'contents', 'preferences', 'folders', 'entries', 'items', 'posts', 'articles', 'sources', 'categories', 'bundle.js', 'main.js', 'app.js', 'vendor.js', 'runtime.js', 'common.js', 'util.js', 'script.js', 'index.js', 'index.mjs', 'main.mjs', 'app.mjs', 'vendor.mjs', 'runtime.mjs', 'framework.js', 'framework.mjs', 'polyfills.js', 'polyfills.mjs', 'styles.js', 'styles.css', 'icon.svg', 'logo.svg', 'favicon.ico', 'manifest.json', 'robots.txt', '_next/static/', '_app/', '_nuxt/', 'static/js/', 'static/css/', 'static/media/', 'i18n/', 'locales/', 'theme.js', 'config.js', 'web.config', 'sitemap.xml', 'chunk-vendors', 'chunk-common', 'component---']);
/**

🚫 路徑黑名單 (V27 擴充) */ const PATH_BLOCK_KEYWORDS = new Set([ // Core (V25) '/ad/', '/ads/', '/adv/', '/advert/', '/advertisement/', '/advertising/', '/affiliate/', '/sponsor/', '/promoted/', '/banner/', '/popup/', '/interstitial/', '/preroll/', '/midroll/', '/postroll/', '/track/', '/trace/', '/tracker/', '/tracking/', '/analytics/', '/analytic/', '/metric/', '/metrics/', '/telemetry/', '/measurement/', '/insight/', '/intelligence/', '/monitor/', '/monitoring/', '/log/', '/logs/', 'logger', '/logging/', '/logrecord/', '/putlog/', '/audit/', '/event/', '/beacon/', '/pixel/', '/collect?', '/collector/', '/report/', '/reports/', '/reporting/', '/sentry/', '/bugsnag/', '/crash/', '/error/', '/exception/', '/stacktrace/', 'google_ad', 'pagead', 'adsbygoogle', 'doubleclick', 'adsense', 'dfp', 'google-analytics', 'fbevents', 'fbq', 'addthis', 'sharethis', 'taboola', 'criteo', 'osano', 'onead', 'sailthru', 'tapfiliate', 'appier', 'hotjar', 'comscore', 'mixpanel', 'amplitude', 'amp-ad', 'amp-analytics', 'amp-auto-ads', 'amp-sticky-ad', 'amp4ads', 'prebid', 'apstag', 'pwt.js', 'utag.js', 'rtb', 'dsp', 'ssp', 'cookiepolicy', 'gdpr', 'ccpa', 'plusone', 'optimize', 'pushnotification', 'ad_logic', 'ad-choices', 'ad-manager', 'ad-server', 'ad-tag', 'ad_pixel', 'ad-request', 'ad-system', 'ad-tech', 'ad-wrapper', 'ad-loader', 'ad-placement', 'user-analytics', 'behavioral-targeting', 'data-collection', 'data-sync', 'fingerprint', 'fingerprinting', 'third-party-cookie', 'user-cohort', 'web-vitals', 'performance-tracking', 'real-user-monitoring', 'attribution', 'retargeting', 'audience', 'cohort', 'user-segment', 'ad-metrics', 'ad-events', 'ad-impression', 'ad-click', 'ad-view', 'ad-engagement', 'ad-conversion', 'user-behavior', 'session-replay', 'privacy-policy', 'cookie-consent', // V27 New Additions 'ad-break', 'ad_event', 'ad-inventory', 'ad-specs', 'ad-verification', 'ad-viewability', 'ad-exchange', 'ad-network', 'ad-platform', 'ad-response', 'ad-slot', 'ad-unit', 'ad-call', 'ad-code', 'ad-script', 'ad-telemetry', '/adserve/', '/adserving/', '/adframe/', '/adrequest/', '/adretrieve/', '/getads/', '/getad/', '/fetch_ads/' ]);
/**

💧 直接拋棄請求的關鍵字 (V27 擴充) */ const DROP_KEYWORDS = new Set([ // Core (V25) 'log', 'logs', 'logger', 'logging', 'amp-loader', 'amp-analytics', 'beacon', 'collect?', 'collector', 'telemetry', 'crash', 'error-report', 'metric', 'insight', 'audit', 'event-stream', 'ingest', 'live-log', 'realtime-log', 'data-pipeline', 'rum', 'intake', 'batch', 'diag', 'client-event', 'server-event', 'heartbeat', // V27 New Additions 'web-vitals', 'performance-entry', 'diagnostic.log', 'user-action', 'stacktrace', 'csp-report', 'profiler', 'trace.json', 'usage.log' ]);
/**

🗑️ 追蹤參數黑名單 (V27 擴充) */ const GLOBAL_TRACKING_PARAMS = new Set([ // Core & Taiwan Lists (V25) 'utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content', 'utm_id', 'utm_source_platform', 'utm_creative_format', 'utm_marketing_tactic', 'gclid', 'dclid', 'gclsrc', 'wbraid', 'gbraid', 'gad_source', 'gad', 'gcl_au', 'msclkid', 'yclid', 'msad', 'mscampaignid', 'msadgroupid', 'fbclid', 'fbadid', 'fbcampaignid', 'fbadsetid', 'fbplacementid', 'igshid', 'igsh', 'x-threads-app-object-id', 'mibextid', 'mc_cid', 'mc_eid', 'mkt_tok', 'email_source', 'email_campaign', 'from', 'source', 'ref', 'referrer', 'campaign', 'medium', 'content', 'spm', 'scm', 'share_source', 'share_medium', 'share_plat', 'share_id', 'share_tag', 'from_source', 'from_channel', 'from_uid', 'from_user', 'tt_from', 'tt_medium', 'tt_campaign', 'share_token', 'share_app_id', 'xhsshare', 'xhs_share', 'app_platform', 'share_from', 'weibo_id', 'wechat_id', 'is_copy_url', 'is_from_webapp', 'pvid', 'fr', 'type', 'scene', 'clickid', 'traceid', 'request_id', '__twitter_impression', '_openstat', 'hsCtaTracking', 'hsa_acc', 'hsa_cam', 'hsa_grp', 'hsa_ad', 'hsa_src', 'vero_conv', 'vero_id', 'ck_subscriber_id', 'action_object_map', 'action_type_map', 'action_ref_map', 'feature', 'src', 'si', 'trk', 'trk_params', 'ttclid', 'twclid', 'li_fat_id', 'epik', 'piwik_campaign', 'piwik_kwd', 'matomo_campaign', 'matomo_kwd', '_bta_c', '_bta_tid', 'oly_anon_id', 'oly_enc_id', 'redirect_log_mongo_id', 'redirect_mongo_id', 'sb_referer_host', 'ecid', 'from_ad', 'from_search', 'from_promo', 'camid', 'cupid', // V25 China Expansion (Retained) 'hmsr', 'hmpl', 'hmcu', 'hmkw', 'hmci', // Baidu Tongji 'union_id', 'biz', 'mid', 'idx', // WeChat // V27 New Additions 'ad_id', 'adgroup_id', 'campaign_id', 'creative_id', 'keyword', 'matchtype', 'device', 'devicemodel', 'adposition', 'network', 'placement', 'targetid', 'feeditemid', 'loc_physical_ms', 'loc_interest_ms', 'creative', 'target', 'adset', 'ad', 'pixel_id', 'event_id', 'rb_clickid', 's_kwcid', 'ef_id', 'algolia_query', 'algolia_query_id', 'algolia_object_id', 'algolia_position', '_ga', '_gid', '_gat', '__gads', '__gac', 'zanpid', 'affid', 'affiliate_id', 'partner_id', 'sub_id', 'transaction_id', 'customid', 'click_id', 'offer_id', 'promo_code', 'coupon_code', 'deal_id' ]);
/**
...
📊 性能統計器 (無變更) */ class PerformanceStats { constructor() { this.stats = { totalRequests: 0, blockedRequests: 0, criticalTrackingBlocked: 0, domainBlocked: 0, pathBlocked: 0, paramsCleaned: 0, whitelistHits: 0, errors: 0 }; } increment(type) { if (this.stats.hasOwnProperty(type)) this.stats[type]++; } getBlockRate() { const total = this.stats.totalRequests; return total > 0 ? ((this.stats.blockedRequests / total) * 100).toFixed(2) + '%' : '0%'; } } const performanceStats = new PerformanceStats();
/**

🚨 關鍵追蹤內容檢查 (V28 邏輯修正)
@description 修正為分離 pathname 和 fullPath 進行檢查，解決 V27 中因查詢參數導致的腳本名稱匹配失敗問題。 */ function isCriticalTrackingScript(pathname, fullPath) { // 1. 從純路徑 (pathname) 中精確提取並匹配腳本文件名 const scriptName = pathname.substring(pathname.lastIndexOf('/') + 1); if (CRITICAL_TRACKING_SCRIPTS.has(scriptName)) { return true; } // 2. 針對包含查詢參數的完整路徑 (fullPath) 檢查路徑模式 for (const pattern of CRITICAL_TRACKING_PATTERNS) { if (fullPath.includes(pattern)) { return true; } } return false; }
/**

🔍 域名白名單檢查 (無變更) */ function isApiWhitelisted(hostname) { if (API_WHITELIST_EXACT.has(hostname)) return true; for (const [domain, _] of API_WHITELIST_WILDCARDS) { if (hostname === domain || hostname.endsWith('.' + domain)) { return true; } } return false; }
/**

🚫 域名黑名單檢查 (V27 邏輯優化)
@description 改為更安全的子域名匹配，防止誤殺。 */ function isDomainBlocked(hostname) { let currentDomain = hostname; while (currentDomain) { if (BLOCK_DOMAINS.has(currentDomain)) { return true; } const dotIndex = currentDomain.indexOf('.'); if (dotIndex === -1) break; currentDomain = currentDomain.substring(dotIndex + 1); } return false; }
/**

🛤️ 路徑攔截檢查 (V28 邏輯修正)
@description 修正為僅對 pathname 進行檢查，避免查詢參數干擾白名單和黑名單的判斷。 */ function isPathBlocked(pathname) { // 先檢查是否命中白名單，如果命中則直接跳過黑名單檢查 for (const allowPattern of PATH_ALLOW_PATTERNS) { if (pathname.includes(allowPattern)) { return false; } } // 未命中白名單，再檢查黑名單 for (const keyword of PATH_BLOCK_KEYWORDS) { if (pathname.includes(keyword)) { return true; } } return false; }
/**

🧹 參數清理功能 (V27 邏輯修正)
@description 修正為使用 TRACKING_PREFIX_REGEX 進行前綴匹配。 */ function cleanTrackingParams(url) { let paramsChanged = false; const keysToDelete = []; for (const key of url.searchParams.keys()) { const lowerKey = key.toLowerCase(); if (GLOBAL_TRACKING_PARAMS.has(lowerKey) || TRACKING_PREFIX_REGEX.test(lowerKey)) { keysToDelete.push(key); paramsChanged= true;
}
}
if (paramsChanged) {
...
🎯 統一攔截響應生成器 (V27 新增) */ function getBlockResponse(path) { // 檢查是否需要拋棄請求 for (const dropKeyword of DROP_KEYWORDS) { if (path.includes(dropKeyword)) { return DROP_RESPONSE; } } // 檢查是否為圖片，是則返回透明GIF const imageExtensions = ['.gif', '.svg', '.png', '.jpg', '.jpeg', '.webp', '.ico']; if (imageExtensions.some(ext => path.endsWith(ext))) { return TINY_GIF_RESPONSE; } // 預設返回 403 攔截 return REJECT_RESPONSE; }
/**
...
if (!request || !request.url) return null;
 ...
 try {
     ...
     // console.error(`[URL-Filter-v28] URL 格式錯誤: ${request.url}`, e);
     return null;
 }

 const hostname = url.hostname.toLowerCase();
 // V28 修正: 分離 pathname 和 fullPath
 const pathname = url.pathname.toLowerCase();
 const fullPath = pathname + url.search.toLowerCase();
 ...
 // V28 修正: 傳入分離後的 pathname 和 fullPath
 if (isCriticalTrackingScript(pathname, fullPath)) {
     performanceStats.increment('criticalTrackingBlocked');
     performanceStats.increment('blockedRequests');
     return getBlockResponse(fullPath);
 }
...
console.error('[URL-Filter-v28] 處理錯誤:', error);
}
...
version: '28.0',
status: 'ready',
message: 'URL Filter v28.0 - Optimized',
});
}
return;
}
...
performanceStats.increment('errors');
if (typeof console !== 'undefined' && console.error) {
console.error('[URL-Filter-v28] 致命錯誤:', error);
}
if (typeof $done !== 'undefined') {
$done({});
}
...
// ### ✨ 核心修正:
//
// 1.  修正 isCriticalTrackingScript 腳本匹配邏輯:
//     - 問題: V27 版本在提取腳本名稱時，未排除 URL 的查詢參數 (Query String)。例如，對於 .../gtm.js?id=G-XXXXX，會提取出 gtm.js?id=G-XXXXX 作為腳本名，導致無法命中 CRITICAL_TRACKING_SCRIPTS 名單中的 gtm.js，造成攔截失效。
//     - 解決: 重新設計了此函數的邏輯。現在會將 URL 的路徑 (pathname) 和包含查詢參數的完整路徑 (fullPath) 分開處理。使用 pathname 來精確提取無參數的腳本檔名進行匹配，同時使用 fullPath 來匹配 CRITICAL_TRACKING_PATTERNS 中的模式。此修正確保了無論腳本 URL 後是否帶有參數，都能被準確識別和攔截。
//
// 2.  修正 isPathBlocked 路徑匹配邏輯:
//     - 問題: V27 版本將包含查詢參數的完整路徑傳遞給此函數進行黑白名單比對。這可能導致查詢參數中的字符意外觸發路徑攔截規則，或干擾路徑白名單的判斷，降低了過濾的精準度。
//     - 解決: 此函數現在只接收並比對不含查詢參數的 pathname。這使得路徑的白名單和黑名單規則僅作用於 URL 的結構本身，完全排除了查詢參數的干擾，讓路徑攔截的行為更加穩定和可預測。
//
// 3.  代碼結構優化:
//     - 在 processRequest 函數中，明確分離出 pathname 和 fullPath 兩個變量，使代碼意圖更清晰，並為上述兩個核心修正提供了支持。
//     - 更新了相關函數的註釋，以反映 V28 版本中的邏輯變更。
//
// ### 🌟 總結:
//
// V28.0 是一個關鍵的穩定性修復版本。它解決了 V27 中因處理查詢參數不當而導致的兩處主要邏輯缺陷，大幅提升了腳本在真實網路環境下的過濾準確性和可靠性。
