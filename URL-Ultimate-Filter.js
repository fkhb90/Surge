/**
 * @file        URL-Ultimate-Filter-Surge-V38.6-fixed.js
 * @version     38.6-fixed (修正黑白名單失效問題)
 * @description 恢復 Set 結構並修正判斷邏輯，確保黑白名單正常生效。保留 /v.*/event 攔截規則。
...
(function () {
  try {
    ...
    if (typeof $request === 'undefined') {
      if (typeof $done !== 'undefined') $done({ version: '38.6-fixed' });
      return;
    }
