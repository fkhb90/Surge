 ...
 * @version   43.86 (YouTube Shorts Telemetry)
 * @description [V43.86] 針對性隱私強化：
 * 1) [Block] 新增 YouTube Shorts 觀看序列遙測 (reel_watch_sequence) 阻擋規則。
 * 2) [Base] 繼承 V43.85 所有效能優化與防護架構。
...
const RULES = {
  ...
  CRITICAL_PATH: {
    ...
    MAP: new Map([
      ...
      // [V43.86] Added /youtubei/v1/reel/reel_watch_sequence
