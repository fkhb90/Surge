/**
 * @file        URL-Ultimate-Filter-Surge-V38.7-stable.js
 * @version     38.7-stable (基於 38.3 穩定版並整合新規則)
 * @description 恢復至 38.3 版的穩定 Map 結構，修正白名單失效問題，並整合 /v.*/event 攔截規則。
...
const CONFIG = {
  ...
  // [修正] 萬用字元白名單必須使用 Map 結構才能正確匹配子域名
...
// [修正] 確保 getWhitelistStatus 正確處理 Map 和 Set 結構
...
(function () {
  try {
    ...
    if (typeof $request === 'undefined') {
      if (typeof $done !== 'undefined') $done({ version: '38.7-stable' });
      return;
    }
